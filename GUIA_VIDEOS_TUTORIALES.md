...
Crear videos cortos y claros que le muestren a tu cliente cómo usar la plataforma sin necesidad de leer manuales largos.
...
2. Explicar el Dashboard:
   ...
   - Ingresos mensuales
3. Mostrar el menú lateral con todas las opciones
...
4. Mostrar los diferentes tipos:
   - Video
   - Documento
   - Quiz
   - Tarea
5. Crear una lección de video:
   - Opción 1: Subir video directamente
   - Opción 2: Pegar link de YouTube
...
2. Mostrar alternativa con YouTube:
   - Subir video a YouTube (puede ser no listado)
   - Copiar URL
   - Pegar en la plataforma
...
3. Filtrar por curso
4. Ver perfil de un estudiante:
   - Cursos inscritos
   - Progreso
   - Pagos realizados
5. Cómo inscribir manualmente a un estudiante
...
3. Filtrar por:
   ...
   - Curso
4. Explicar qué significa cada estado
5. Cómo verificar que un pago se completó
...
2. Crear nueva plantilla:
   ...
   - Configurar posición de textos
   - Previsualizar
3. Asignar plantilla a un curso
4. Configurar requisitos para obtenerlo
...
3. Crear notificación masiva:
   - Seleccionar grupo (todos o por curso)
   - Escribir mensaje
...
3. Cuando llegue la hora, iniciar sesión
4. Mostrar controles:
   - Compartir pantalla
...
3. Ver progreso de un estudiante individual
...
## 🎬 CONSEJOS PARA GRABAR BUENOS VIDEOS

### Antes de Grabar

1. **Escribe un guion** (no tiene que ser palabra por palabra, pero sí puntos clave)
2. **Practica** la demostración al menos una vez antes de grabar
3. **Cierra pestañas innecesarias** del navegador
4. **Desactiva notificaciones** de Windows/programas
5. **Prepara la plataforma** en el estado que quieres mostrar
...
1. **Edita** para quitar partes innecesarias (silencios largos, errores)
2. **Agrega intro y outro** simple (puede ser solo texto)
3. **Agrega música de fondo** suave (opcional, pero hace más profesional)
4. **Exporta en buena calidad** (1080p recomendado)
5. **Sube a YouTube o Vimeo** y marca como "no listado" si quieres privacidad
...
3. **Windows Game Bar** (Ya incluido en Windows)
   - Presiona `Win + G`
...
## 📝 PLANTILLA DE DESCRIPCIÓN PARA YOUTUBE

Cuando subas los videos a YouTube, usa esta descripción:

```
🎓 TUTORIAL: [Nombre del tema]
...
2:15 - [Segundo tema]
5:40 - [Tercer tema]
8:20 - Resumen y conclusiones

📚 RECURSOS:
- Manual completo: [link si lo subes a un Drive o similar]
- Sitio web: [URL de la plataforma]

💬 ¿DUDAS? Deja un comentario abajo.

#EscuelaNorma #Tutorial #PlataformaEducativa
```
...
- [ ] Video grabado en buena calidad (mínimo 720p)
- [ ] Audio claro y sin ruidos de fondo
- [ ] Video editado (sin partes innecesarias)
- [ ] Intro y outro agregados (opcional)
- [ ] Duración apropiada (no más de 15 min por video)
- [ ] Título descriptivo
- [ ] Descripción completa
- [ ] Marcas de tiempo en la descripción
- [ ] Thumbnail/miniatura atractiva (opcional)
- [ ] Subido a YouTube o Vimeo
- [ ] Privacidad configurada (público, no listado, o privado)
...
## 🎤 SCRIPT DE INICIO PARA TODOS LOS VIDEOS

> "Hola, bienvenida/o a este tutorial de tu plataforma educativa Escuela de Norma. Yo soy [tu nombre], el desarrollador de la plataforma. En este video te voy a mostrar [tema del video]. Este tutorial va a durar aproximadamente [X] minutos. Si en algún momento tenés dudas, podés pausar el video y volver a verlo. También tenés un manual escrito que podés consultar. ¡Empecemos!"

---

## 🎤 SCRIPT DE CIERRE PARA TODOS LOS VIDEOS

> "Y eso es todo para este tutorial. Recapitulando, vimos cómo [resumen rápido]. Si tenés alguna duda o necesitás ayuda con algo, no dudes en contactarme. En el próximo video vamos a ver [tema del siguiente video]. ¡Gracias por ver y nos vemos en el siguiente tutorial!"

---

## 💡 TIPS EXTRA

1. **Graba en varias sesiones** - No necesitas grabar todo en un día
2. **Numera los videos** - Ayuda al cliente a seguir el orden
3. **Mantén consistencia** - Usa el mismo formato en todos los videos
4. **Pregunta feedback** - Después de los primeros videos, pregunta si se entiende
5. **Actualiza cuando haya cambios** - Si cambias algo en la plataforma, actualiza el video

---

**🎬 ¡Suerte con tus grabaciones!**

Recuerda: No tiene que ser perfecto, tiene que ser útil. Tu cliente valorará más la claridad que la producción hollywoodense.
