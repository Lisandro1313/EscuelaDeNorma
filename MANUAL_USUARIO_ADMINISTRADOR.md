...
- ✅ Crear evaluaciones y certificados
...
- **Pagos**: Ver transacciones y pagos
- **Contenido**: Subir videos y materiales
- **Certificados**: Configurar certificados
...
2. Completa el formulario básico:
   ...
   - **Descripción corta**
   - **Descripción completa** (con detalles del contenido)
   - **Precio** (en pesos argentinos)
   - **Categoría** (Musical, Artístico, Académico, etc.)
   - **Nivel** (Principiante, Intermedio, Avanzado)
3. Sube una **imagen de portada** (recomendado: 1280x720px)
...
2. Completa:
   ...
   - **Tipo** (Video, Documento, Quiz, Tarea)
   - **Contenido**:
     - Si es video: sube el archivo o pega URL de YouTube/Vimeo
     - Si es documento: sube PDF/Word
     - Si es texto: escribe directamente
3. Marca si es **gratuita** (visible para todos) o **premium** (solo inscritos)
...
4. Elige el video de tu computadora
5. Espera a que se suba (puede tardar según el tamaño)
6. Guarda la lección
...
2. Haz clic en **"Inscripciones"**
3. Haz clic en **"Inscribir Estudiante"**
4. Selecciona el estudiante del listado
5. Marca como **"Pagado"** si ya pagó
...
2. Ingresa tus nuevas credenciales de MercadoPago:
   - Public Key
   - Access Token
...
3. Para cada pregunta:
   - Escribe la pregunta
   - Agrega opciones de respuesta (mínimo 2)
   - Marca la respuesta correcta
   - Asigna puntaje (ej: 10 puntos)
4. Configura:
   - **Tiempo límite**: Cuánto tiempo tiene el estudiante
   - **Intentos permitidos**: Cuántas veces puede intentar
   - **Puntaje mínimo para aprobar**: Ej: 70%
5. Guarda el quiz
...
3. Configura:
   - **Fecha de entrega**
   - **Formato de entrega** (archivo, texto, ambos)
...
4. Descarga el archivo si subieron uno
5. Asigna una calificación (0-100)
6. Escribe retroalimentación (opcional pero recomendado)
...
4. Configura las posiciones de texto:
   - Nombre del estudiante
   - Nombre del curso
   - Fecha de finalización
   - Firma del instructor
5. Previsualiza cómo se verá
...
4. Selecciona la plantilla de certificado
5. Define los requisitos:
   - Completar X% de lecciones
...
- **Tasa de finalización**: % de estudiantes que completan cursos
...
3. Selecciona destinatarios:
   ...
   - Solo estudiantes de un curso específico
...
- **Silenciar participantes**: Controlar audio
- **Compartir documentos**: Subir PDFs o imágenes
...
2. Puedes modificar:
   ...
   - **Logo** (aparece en toda la plataforma)
   - **Colores de la marca**
...
2. Define:
   ...
   - Validez de acceso (permanente o por tiempo limitado)
...
- [ ] Configurar información de la escuela (nombre, logo, colores)
- [ ] Configurar credenciales de MercadoPago
- [ ] Crear primera categoría de cursos
- [ ] Crear primer curso de prueba
- [ ] Subir contenido al curso (al menos 1 lección)
- [ ] Publicar el curso
- [ ] Crear cuenta de estudiante de prueba
- [ ] Probar inscripción al curso
- [ ] Probar que el estudiante vea el contenido
- [ ] Configurar plantilla de certificado
- [ ] Probar envío de notificaciones
- [ ] Revisar que los pagos funcionen
- [ ] Invitar a los primeros estudiantes

---

**🎉 ¡Felicidades! Ya estás lista para gestionar tu escuela en línea.**

Recuerda: La práctica hace al maestro. Explora todas las funcionalidades y no dudes en experimentar.
